...
namespace SIS.MvcFramework.Services
{
    public class UserCookieService : IUserCookieService
    {
        ...
        protected const string EncryptKey = "E646C8DF278CD5931069B522E695D4F2";
        ...
        public string EncryptString(string clearText, string keyString = EncryptKey)
        {
        ...
        public string DecryptString(string cipherText, string keyString = EncryptKey)
        {
